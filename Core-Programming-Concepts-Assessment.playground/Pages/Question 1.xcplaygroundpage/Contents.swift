...
var tempretureInCelsiusc : Double = 20
var tempretureInFahrenheit = tempretureInCelsiusc * 9 / 5 + 32
print("A temperature in degrees Celsius of \(tempretureInCelsiusc) is equal to \(tempretureInFahrenheit) in degrees Fahrenheit.")
